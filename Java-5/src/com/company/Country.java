...
public class Country
{
    ...
    public static Comparator<Country> byNameAsc = Comparator.comparing(o -> o.nameCountry);
    public static Comparator<Country> byNameDesc = (o1, o2) -> o2.nameCountry.compareTo(o1.nameCountry);
